...
def activate_virtual_environment(venv_name):
    ...
    python_command = "python face_fusion.py '/root/autodl-tmp/aifamily_demo/final.png' '/root/autodl-tmp/lora-scripts-main/train/face/10_face/processed_20230726-185747.jpeg' "
